      ...
      <div className="container mx-auto px-4 py-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center space-x-2">
                <svg className="w-4 h-4 text-primary-pink" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-100 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-text-light mb-4 md:mb-0">
            &copy; 2025 PregCare. All rights reserved. Made for every couple's dream.
          </p>
