# ============================================
# PregCare Backend Startup Script (Django)
# ============================================
# This script starts the Django backend server
# Keep this terminal open while using the frontend!
# ============================================

Write-Host "`n[STARTUP] Starting PregCare Django Backend..." -ForegroundColor Cyan
...
Write-Host "`n[INFO] Backend Configuration:" -ForegroundColor Cyan
